...
public static class PermissionSeeder
{
    ...
    [
        ...
        ("ADMIN", "REPUTATION.ADMIN.VIEW"), ("SUPPORT_STAFF", "REPUTATION.ADMIN.VIEW"),
        ("ADMIN", "REPUTATION.ADMIN.ADJUST"),
        ("ADMIN", "REPUTATION.ADMIN.REVERSE"),
        ("ADMIN", "REPUTATION.RESTRICTION.CLEAR"),
